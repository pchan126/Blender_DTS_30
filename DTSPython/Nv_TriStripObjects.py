...
class NvStripInfo:
    ...
    def Build(self, edgeInfos, faceInfos):
        ...
        if self.m_startInfo.m_toV1:
            v0 = self.m_startInfo.m_startEdge.m_v0
        else:
            v0 = self.m_startInfo.m_startEdge.m_v1

        if self.m_startInfo.m_toV1:
            v1 = self.m_startInfo.m_startEdge.m_v1
        else:
            v1 = self.m_startInfo.m_startEdge.m_v0
...
class NvStripifier:
    ...
    def AlreadyExists(self, faceInfo, faceInfos):
        for i in range(0, len(faceInfos)):
            if (faceInfos[i].m_v0 == faceInfo.m_v0) and (faceInfos[i].m_v1 == faceInfo.m_v1) and (
